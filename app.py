...
class App:
    ...
    def init_gui(self):
        ...
        # Prompting for class names at the start might not be the best UX in a GUI application
        # Consider setting default names or creating a settings dialog to handle this
    ...
    def save_for_class(self, class_num):
        ...
        if ret:
            ...
            if not os.path.exists(directory):
                os.mkdir(directory)
            filepath = f'{directory}/frame{self.counters[class_num-1]}.jpg'
